...
const ProductsPage: React.FC<ProductsPageProps> = ({ products, cart, onAddToCart, onUpdateQuantity, onNavigate }) => {
                ...
                return (
                  <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group border border-yellow-200 transform hover:-translate-y-1">
                    ...
                    >
                      ...
                      {currentQuantity > 0 && (
                        <div className="absolute bottom-4 right-4 bg-green-500 text-white px-2 py-1 rounded-full text-xs font-bold shadow-lg">
                    ...
                    <div className="p-6">
                      ...
                      <h4 
                        className="text-lg font-bold text-gray-800 mb-2 line-clamp-2 min-h-[3.5rem] cursor-pointer hover:text-yellow-800 transition-colors"
                        onClick={() => onNavigate('product-detail', product.id)}
                      >
                        {product.name}
                      </h4>
